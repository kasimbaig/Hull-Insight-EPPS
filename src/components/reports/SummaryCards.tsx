...
import { ReportData, LoadingStates, HvacReport } from "@/types/reports";

interface SummaryCardsProps {
  data: ReportData;
  loadingStates: LoadingStates;
  onRefreshTotalTrials: () => void;
  onRefreshHvacReports?: () => void;
  selectedVessel?: string;
}

export const SummaryCards = ({ data, loadingStates, onRefreshTotalTrials, onRefreshHvacReports, selectedVessel }: SummaryCardsProps) => {
  ...
  // Calculate the actual HVAC trials count that would be displayed in the table
  const hvacTrialsCount = hvacReport?.trials.length || 0;
