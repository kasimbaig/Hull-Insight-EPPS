import { HvacTrial, DockingReport, SurveyReport } from '@/types/reports';
...
export const useReportActions = () => {
  ...
  const [selectedTrial, setSelectedTrial] = useState<HvacTrial | null>(null);
  const [selectedDockingReport, setSelectedDockingReport] = useState<DockingReport | null>(null);
  const [selectedSurveyReport, setSelectedSurveyReport] = useState<SurveyReport | null>(null);
  ...
  const handlePreviewReport = async (
    ...
    try {
      if (rowData.report_type === "HVAC Trial") {
        ...
        const trial = hvacReport.trials.find((t: HvacTrial) => t.id === rowData.id);
        if (!trial) {
          toast({
